...
print("\n" + "="*80)
print("YOUR CONFIGURATION: $2,500 Capital | 3x Leverage | 1% Risk")
print("="*80)
...
if len(trades_full) > 0:
    ...
    annual_return_pct = (total_pnl / 2500) / years * 100

    # Total fees
    total_fees = trades_full['fees'].sum()

    # Final balance
    final_balance = 2500 + total_pnl
    total_return_pct = (total_pnl / 2500) * 100
    ...
    print(f"  Avg Margin Used: ${avg_margin:,.2f} ({avg_margin/2500*100:.1f}% of capital)")
    print(f"  Max Margin Used: ${max_margin:,.2f} ({max_margin/2500*100:.1f}% of capital)")
...
print("="*80)
print(f"\n💡 KEY TAKEAWAYS FOR $2,500 @ 3x LEVERAGE:")
print(f"  • Risk per trade: $25 (1% of $2,500)")
print(f"  • Expected trades: 15-20 per year")
print(f"  • Typical win: $40-80")
print(f"  • Typical loss: $20-30")
print(f"  • Position size: ~8,000-12,000 ADA per trade")
print(f"  • Margin needed: $1,400-1,700 per trade (56-68% of capital)")
print(f"\n⚠️  IMPORTANT:")
print(f"  • Keep $500-750 buffer for volatility")
print(f"  • Monitor margin usage closely")
print(f"  • Stop trading if down $125 (5% of capital)")
print(f"  • Consider 2x leverage if margin feels tight")
